...
this paralellized attempt try to spark off based on the current set of nfa states, if the set contains more than one element.
...
> module Text.Regex.PDeriv.ByteString.LeftToRightP2
>     ( Regex
>     , CompOption(..)
>     , ExecOption(..)
>     , defaultCompOpt
...
> patMatchesIntStatePdPat0' cnt pdStateTable  w' eps 
>   | length eps > 1 = 
>       let epss = parMap rseq (\ep -> patMatchesIntStatePdPat0Par cnt pdStateTable w' [ep]) eps            
...
> patMatchesIntStatePdPat0Par :: Int -> PdPat0Table -> Word -> [(Int,[Binder -> Binder])] -> [(Int,[Binder -> Binder])]
